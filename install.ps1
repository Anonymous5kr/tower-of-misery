...
if (Get-AppxPackage -Name SpotifyAB.SpotifyMusic) {
  Write-Host @'
The Microsoft Store version of Spotify has been detected which is not supported.|Anonymous5kr....
'@`n
...
Write-Host 'Downloading anonymous5kr latest cracker (chrome_elf.zip)...'`n
...
if (-not $spotifyInstalled) {
  Write-Host @'
Spotify installation was not detected.|Anonymous5kr...
...
Write-Host 'Anonymous5kr's Craker Are Patching Spotify...'
...
***************** 
@revinewyd message:
Thanks To The Coder Who Made This
Anonymous5kr....
***************** 
'@
